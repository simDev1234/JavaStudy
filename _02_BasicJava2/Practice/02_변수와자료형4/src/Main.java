...
//      1-4. remove
        System.out.println("remove : "+l1.remove(0)); //index : 0의 값 지우기
        System.out.println("l1 = " + l1);
        System.out.println(l1.remove(Integer.valueOf(2))); //(Object)형태 데이터 지우기
        System.out.println("l1 = " + l1);
...
//      2-1. put
        ...
        map.put("apple", 10000);
        map.put("mango", 12000);
        System.out.println("map = " + map); //entrySet (key = value) 값으로 반환

//      2-2. get
        System.out.println(map.get("mandarin")); //데이터가 없기에 null 출력
...
//      2-4. remove
        System.out.println(map.remove("kiwi")); // 지운 값 출력
